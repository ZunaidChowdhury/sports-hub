                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div className="card bg-foreground rounded-xl shadow-md p-6 flex flex-col justify-center">
                            <span className="text-sm font-medium uppercase flex items-center gap-2"><MdOutlineLocationOn className='w-5 h-5'/>Location</span>
                            <span className="text-lg font-semibold tracking-normal mt-1">{facility.location}</span>
                        </div>

                        <div className="card bg-foreground shadow-md rounded-xl p-6  flex flex-col justify-center">
                            <span className="text-sm font-medium uppercase flex items-center gap-2"><MdOutlinePeopleAlt className='w-5 h-5' /> Capacity</span>
                            <span className="text-lg font-semibold tracking-normal mt-1">{facility.capacity}</span>
                        </div>

                        <div className="card bg-foreground shadow-md p-6 rounded-xl flex flex-col justify-center">
                            <span className="text-sm font-medium uppercase flex items-center gap-2"><ImPriceTags className='w-5 h-5' /> Price</span>
                            <span className="text-lg font-semibold tracking-normal mt-1">${facility.pricePerHour}/hour</span>
                        </div>

                        <div className="card bg-foreground shadow-md p-6 rounded-xl flex flex-col justify-center">
                            <span className="text-sm font-medium uppercase flex items-center gap-2"><LuClock4 className='w-5 h-5' /> Slots</span>
                            <span className="text-lg font-semibold tracking-normal mt-1">{Math.floor(Math.random() * 7) + 6} available</span>
                        </div>
                    </div>

                    {/* Description Section */}
                    <div className="space-y-2 bg-foreground shadow-md rounded-xl p-6">
                        <h3 className="text-lg font-bold tracking-normal">About this facility</h3>
